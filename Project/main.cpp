...
//I made it global, so I can change it in any function, and it will be changed in all of them
//Make it cleaner so when I get the user input it will automatically change
// the empty
